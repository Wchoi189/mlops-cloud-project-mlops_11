...
def test_api_endpoints():
    ...
    tests = [
        ...
        },
        {
            ...
            "data": {
                "text": "This is an amazing movie with great acting!"
            }
        }
    ]
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if test['name'] == "헬스 체크":
                    ...
                    print(f"      예측 평점: {result_data.get('predicted_rating', 'N/A')}/10")
    ...
    print(f"⚡ 평균 응답 시간: {sum(r['time'] for r in results if r['time'] > 0) / max(1, len([r for r in results if r['time'] > 0])):.2f}초")
...
def demo_predictions():
    ...
    demo_movies = [
        {"title": "Avengers: Endgame", "startYear": 2019, "runtimeMinutes": 181, "numVotes": 1000000},
        {"title": "Parasite", "startYear": 2019, "runtimeMinutes": 132, "numVotes": 750000},
        {"title": "Joker", "startYear": 2019, "runtimeMinutes": 122, "numVotes": 1200000},
        {"title": "The Room", "startYear": 2003, "runtimeMinutes": 99, "numVotes": 100000},
        {"title": "Independent Film", "startYear": 2023, "runtimeMinutes": 95, "numVotes": 1000}
    ]
    ...
    for movie in demo_movies:
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"   런타임: {movie['runtimeMinutes']}분, 투표수: {movie['numVotes']:,}")
                print()
            else:
