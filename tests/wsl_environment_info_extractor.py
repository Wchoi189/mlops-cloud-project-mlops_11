...
def get_wsl_environment_info():
    ...
    env_info['hardware'] = {
        ...
        'gpu_info': run_command('nvidia-smi --query-gpu=name,memory.total,driver_version --format=csv,noheader,nounits'),
    }
    ...
    env_info['python'] = {
        ...
        'conda_info': run_command('conda info --json') if run_command('which conda') != "Not available" else "Not installed",
    ...
    ml_packages = [
        ...
        'jupyter', 'ipython', 'plotly', 'scipy', 'statsmodels'
    ]
    ...
    important_env_vars = [
        'PATH', 'PYTHONPATH', 'CUDA_VISIBLE_DEVICES', 'CUDA_HOME',
        'LD_LIBRARY_PATH', 'HOME', 'USER', 'SHELL'
    ]
