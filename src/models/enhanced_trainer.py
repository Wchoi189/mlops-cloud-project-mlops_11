...
class EnhancedMovieRatingTrainer:
    ...
    def load_data(self, data_path: str = "data/processed/movies_with_ratings.csv") -> pd.DataFrame:
        ...
        display_table(
            ...
            [
                ...
                ["Rating Range", f"{df[self.TARGET_COLUMN].min():.1f} - {df[self.TARGET_COLUMN].max():.1f}"]
            ]
        )
    ...
    def prepare_features(self, df: pd.DataFrame) -> Tuple[np.ndarray, np.ndarray]:
        ...
        self.logger.success(f"Features prepared: {len(X)} samples, {len(available_features)} features")
        ...
        if HAS_RICH:
            ...
            display_table("Feature-Target Correlations", ["Feature", "Correlation"], correlations)
    ...
    def train_model(self, X: np.ndarray, y: np.ndarray, 
        ...
        display_table(
            ...
            [
                ...
                ["R² Score", f"{metrics['r2_score']:.4f}", "Higher is better (max 1.0)"],
    ...
    try:
        ...
        display_table(
            ...
            [
                ...
                ["Feature Prep", "✅ Success", f"{len(trainer.feature_names)} features"],
