...
class PredictionRequest(BaseModel):
    ...
    startYear: Optional[int] = Field(None, ge=1900, le=2030, description="Movie release year")
    runtimeMinutes: Optional[int] = Field(None, ge=1, le=600, description="Movie runtime in minutes")
