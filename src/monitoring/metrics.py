...
class MLOpsMetrics:
    ...
    def record_prediction_rating(self, rating: float):
        ...
        self.prediction_ratings_distribution.labels(
    ...
    def record_model_accuracy(self, accuracy: float, model_name: str = "default",
    ...
    def record_resource_usage(self, component: str, memory_bytes: int, 
                            cpu_percent: float):
    ...
    def record_mlflow_experiment(self, experiment_name: str, status: str = "completed"):
        ...
        self.mlflow_experiments_total.labels(
...
def update_health_metrics():
    ...
    try:
        ...
        metrics.record_resource_usage(
            component="system",
            memory_bytes=system_memory.used,
